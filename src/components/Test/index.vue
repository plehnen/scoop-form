<template>
  <div v-if="isI18nLoaded" class="container-fixed offset-top-2 offset-bottom-10">
    ...
    <div class="container-fixed">
      <VOrderSummaryForm v-bind="orderSummaryForm">
        <button type="submit" class="btn btn-default btn-brand">Abschicken</button>
      </VOrderSummaryForm>
    </div>
  </div>
</template>
...
export default {
  ...
  components: {
    VSelect: () => import('@/components/Form/Select'),
    VCheckbox: () => import('@/components/Form/Checkbox'),
    VMulticheckbox: () => import('@/components/Form/MultiCheckbox'),
    VForm: () => import('@/components/Form'),
    VInput: () => import('@/components/Form/Input'),
    VOrderSummaryForm: () => import('@/views/Substore/Product/OrderSummary/Form'),
  },
  ...
  data() {
    ...
    return {
      ...
      orderSummaryForm: {
        hyperlinks: {
          termsOrderLinkDisplayName: 'termsOrderLinkDisplayName',
          termsOrderLinkUrl: 'termsOrderLinkUrl',
          rescissionOrderLinkDisplayName: 'rescissionOrderLinkDisplayName',
          rescissionOrderLinkUrl: 'rescissionOrderLinkUrl',
        },
        texts: {
          additionalCheckboxHeadlineSummary: 'additionalCheckboxHeadlineSummary',
          emailTextProductOrder: 'emailTextProductOrder',
        },
        textLists: {
          textToBeConfirmedSummary: ['textToBeConfirmedSummary1', 'textToBeConfirmedSummary2'],
        },
        obligationToPay: true,
        customerEmail: 'a@bc.de',
  ...
  computed: {
    isI18nLoaded() {
      return !!this.$i18n.messages.de.substore;
    },
  },
